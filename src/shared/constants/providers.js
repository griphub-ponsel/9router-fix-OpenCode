...
export const OAUTH_PROVIDERS = {
  ...
  notion: { id: "notion", alias: "nt", name: "Notion", icon: "description", color: "#111827", textIcon: "NT", website: "https://notion.com", notice: { text: "OAuth connects official Notion MCP tools. For nt/claude-opus-4-8 and other Notion AI models, add a Notion AI Session with token_v2, spaceId, and userId.", signupUrl: "https://notion.com" }, serviceKinds: ["mcp", "llm"], authModes: ["oauth", "apikey"], toolOnly: true, allowCustomModels: true, hasProviderSpecificData: true, mcpConfig: { url: "https://mcp.notion.com/mcp", transport: "http", oauth: true, tools: ["search", "fetch", "create-pages", "update-page", "move-pages", "duplicate-page", "create-database", "update-database", "create-comment", "get-comments", "get-users", "get-self", "get-user"] } },
