...
export const OAUTH_PROVIDERS = {
  ...
  "codebuddy-cn": { id: "codebuddy-cn", alias: "cbcn", name: "CodeBuddy CN", icon: "psychology", color: "#006EFF", textIcon: "CB", authModes: ["oauth", "apikey"], thinkingConfig: THINKING_CONFIG.effort, website: "https://copilot.tencent.com", notice: { signupUrl: "https://copilot.tencent.com", apiKeyUrl: "https://copilot.tencent.com" }, serviceKinds: ["llm"] },
...
export const APIKEY_PROVIDERS = {
  ...
  merlin: { id: "merlin", alias: "mer", name: "Merlin AI (Pro)", icon: "auto_awesome", color: "#6D28D9", textIcon: "ME", website: "https://www.getmerlin.in", notice: { text: "Paste your getmerlin.in access token — the 'Authorization: Bearer ...' value from a logged-in request (DevTools → Network → any /arcane request). Token expires ~1h; re-paste when it stops working.", apiKeyUrl: "https://www.getmerlin.in/chat" }, serviceKinds: ["llm"] },
