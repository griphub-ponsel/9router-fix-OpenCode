...
export const OAUTH_PROVIDERS = {
  ...
  notion: { id: "notion", alias: "nt", name: "Notion", icon: "description", color: "#111827", textIcon: "NT", website: "https://notion.com", notice: { text: "OAuth connects official Notion MCP tools. For nt/claude-opus-4-8 and other Notion AI models, add a Notion AI Session with token_v2, spaceId, and userId from app.notion.com.", signupUrl: "https://notion.com" }, serviceKinds: ["mcp", "llm"], authModes: ["oauth", "apikey"], toolOnly: true, allowCustomModels: true, hasProviderSpecificData: true, mcpConfig: { url: "https://mcp.notion.com/mcp", transport: "http", oauth: true, tools: ["search", "fetch", "create-pages", "update-page", "move-pages", "duplicate-page", "create-database", "update-database", "create-comment", "get-comments", "get-users", "get-self", "get-user"] } },
  "codebuddy-cn": { id: "codebuddy-cn", alias: "cbcn", name: "CodeBuddy CN", icon: "smart_toy", color: "#006EFF", textIcon: "CB", authModes: ["oauth", "apikey"], thinkingConfig: THINKING_CONFIG.effort, website: "https://copilot.tencent.com", notice: { signupUrl: "https://copilot.tencent.com", apiKeyUrl: "https://copilot.tencent.com" }, serviceKinds: ["llm"] },
  "xai-oauth": { id: "xai-oauth", alias: "xog", name: "xAI Grok", icon: "auto_awesome", color: "#000000", textIcon: "XG", thinkingConfig: THINKING_CONFIG.effort, website: "https://x.ai/grok", notice: { text: "Browser OAuth login at accounts.x.ai. Works with free tier or paid SuperGrok subscription. Uses official xAI API (api.x.ai/v1).", signupUrl: "https://x.ai/grok" }, serviceKinds: ["llm"] },
  glm: { id: "glm", alias: "glm", name: "GLM Coding", icon: "code", color: "#2563EB", textIcon: "GL", authModes: ["oauth", "apikey"], website: "https://z.ai", notice: { text: "Z.AI international (z.ai). OAuth Coding Plan or API key via api.z.ai.", apiKeyUrl: "https://z.ai", signupUrl: "https://z.ai" }, serviceKinds: ["llm"] },
...
export const APIKEY_PROVIDERS = {
  ...
  pioneer: { id: "pioneer", alias: "pn", name: "Pioneer AI", icon: "rocket_launch", color: "#7C5CFF", textIcon: "PN", website: "https://pioneer.ai", notice: { text: "Pioneer AI by Fastino Labs. Free $75 usage credits, no credit card. Add via API key (pio_sk_), Supabase refresh_token, or email + password (hCaptcha required). Only models with supports_on_demand_inference=true work directly — gated models (Claude/GPT/Gemini/etc.) require prior fine-tuning via /felix/training-jobs.", apiKeyUrl: "https://agent.pioneer.ai/settings/api-keys", signupUrl: "https://agent.pioneer.ai/auth" }, hasProviderSpecificData: true, serviceKinds: ["llm"], passthroughModels: false },
