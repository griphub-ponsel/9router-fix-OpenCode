        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            ...
            {tunnelEnabled && !tunnelLoading && tunnelReachable ? (
              <>
                <Input value={`${tunnelPublicUrl || tunnelUrl}/v1`} readOnly className="flex-1 font-mono text-sm min-w-0" />
                <button
              ...
              <>
                <div className="flex-1 flex items-center gap-2 px-3 py-1.5 rounded border border-amber-300 dark:border-amber-800 bg-amber-500/5 text-sm text-amber-600 dark:text-amber-400 min-w-0">
                  <span className="material-symbols-outlined animate-spin text-sm shrink-0">progress_activity</span>
              ...
              <>
                <div className="flex-1 flex items-center gap-2 px-3 py-1.5 rounded border border-border bg-input text-sm text-text-muted min-w-0">
                  <span className="material-symbols-outlined animate-spin text-sm shrink-0">progress_activity</span>
              ...
              <>
                <div className="flex-1 flex items-center gap-2 px-3 py-1.5 rounded border border-red-300 dark:border-red-800 bg-red-500/5 text-sm text-red-600 dark:text-red-400 min-w-0">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            ...
            {tsEnabled && !tsLoading && tsReachable ? (
              <>
                <Input value={`${tsUrl}/v1`} readOnly className="flex-1 font-mono text-sm min-w-0" />
                <button
              ...
              <>
                <div className="flex-1 flex items-center gap-2 px-3 py-1.5 rounded border border-red-300 dark:border-red-800 bg-red-500/5 text-sm text-red-600 dark:text-red-400 min-w-0">
                  <span className="material-symbols-outlined text-sm shrink-0">error</span>
                  <span className="break-words">{tsStatus.message}</span>
                </div>
        ...
        {keys.length === 0 ? (
          ...
          <div className="flex flex-col">
            {keys.map((key) => (
              <div
                key={key.id}
                className={`group flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 py-3 border-b border-black/[0.03] dark:border-white/[0.03] last:border-b-0 ${key.isActive === false ? "opacity-60" : ""}`}
              >
