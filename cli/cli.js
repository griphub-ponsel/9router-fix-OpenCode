...
// Find the packaged Vite client and Express API server.
const standaloneDir = path.join(__dirname, "app");
const serverPath = path.join(standaloneDir, "dist-server", "index.js");

if (!fs.existsSync(serverPath)) {
  console.error("Error: Packaged server build not found.");
