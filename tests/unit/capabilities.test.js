...
describe("getCapabilitiesForModel", () => {
  it.each(["luna", "terra", "sol"])("reports Kiro GPT 5.6 %s as a 1M context model", (variant) => {
    expect(getCapabilitiesForModel("kiro", `gpt-5.6-${variant}`).contextWindow).toBe(1000000);
    expect(getCapabilitiesForModel("kiro", `gpt-5.6-${variant}-thinking`).contextWindow).toBe(1000000);
  });
